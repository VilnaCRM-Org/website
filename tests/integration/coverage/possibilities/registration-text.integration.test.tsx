...
import { RegistrationText } from '@landing-components/Possibilities/RegistrationText';
import RegistrationTextDefault from '@landing-components/Possibilities/RegistrationText/RegistrationText';
