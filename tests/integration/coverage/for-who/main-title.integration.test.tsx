...
import { MainTitle as MainTitleBarrel } from '@landing-components/ForWhoSection/MainTitle';
import MainTitle from '@landing-components/ForWhoSection/MainTitle/MainTitle';
