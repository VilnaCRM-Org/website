...
lint: lint-next lint-tsc lint-md lint-deps lint-headers ## Runs all linters: ESLint, TypeScript, Markdown, dependency-cruiser, and the security-header gate in sequence.
