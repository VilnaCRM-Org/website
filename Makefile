...
build-out: ## Build production artifacts to ./out directory using BuildKit --output
	@echo "🏗️ Building production artifacts with BuildKit..."
	@rm -rf ./out
	DOCKER_BUILDKIT=1 docker build --target build --output type=local,dest=. .
