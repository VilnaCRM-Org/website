...
DOCKER_COMPOSE_SANDBOX_FILE = -f docker-compose.sandbox.yml
...
build-out: ## Build and export the site, output will be saved to ./out
	$(DOCKER_COMPOSE) $(DOCKER_COMPOSE_SANDBOX_FILE) run --rm sandbox
