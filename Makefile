...
lint: lint-next lint-tsc lint-md lint-deps lint-node-version lint-docker-policy ## Runs all linters: ESLint, TypeScript, Markdown, dependency-cruiser, the Node version drift gate, and the Dockerfile registry/digest policy in sequence.
