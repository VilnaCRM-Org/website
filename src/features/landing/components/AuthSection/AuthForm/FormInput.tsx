...
name: 'FullName' | 'Email' | 'Password' | 'Privacy';
  ...
  type: string;
    htmlFor: string;
    component?: 'a' | 'div' | 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6' | 'label' | 'p' | 'section' | 'span';
}

function FormInput({ inputTitle, control, id, name, rules, placeholder, type, htmlFor,component}: FormInputProps): JSX.Element {
