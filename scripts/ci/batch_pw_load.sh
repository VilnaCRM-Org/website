...
run_e2e_tests() {
    print_status "🐳 Running E2E tests in Docker-in-Docker mode"
...
run_visual_tests() {
    print_status "🐳 Running visual tests in Docker-in-Docker mode"
...
run_load_tests() {
    print_status "🐳 Running load tests in Docker-in-Docker mode"
